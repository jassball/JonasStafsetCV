  ...
  return (
    <>
      <div id="edu" className="container">
        <h1>
          <FontAwesomeIcon icon={faGraduationCap} /> Utdannelse
        </h1>
        <div id="" className="row">
          <div id="edu-cards" className="col-lg-5 col-md-12">
            <p>
              <FontAwesomeIcon id="icon" icon={faSchool} />
              Høyskolen Kristiania
            </p>
            <p>
              <FontAwesomeIcon id="icon" icon={faGraduationCap} />
              Bachelor i IT: Frontend- og mobilutvikling
            </p>
            <p>
              <FontAwesomeIcon id="icon" icon={faFilePen} />
              Tre års bachelorgrad bestående av opplæring i digital teknologi,
              webutvikling, brukertesting, interaksjonsdesign og webutvikling.
              Gjennom studiet har jeg jobbet med reelle kundecaser som Vizrt.
              Jeg har vært med på å planlegge og gjennomføre en prosjektcase i
              en tverrfaglig gruppe, og fått trening i å bruke moderne verktøy
              og teknikker.
            </p>
            <p>
          ...
          <div id="edu-cards" className="col-lg-5 col-md-12">
            <p>
              <FontAwesomeIcon id="icon" icon={faSchool} />
              Ålesund VGS: Latin avdeling
            </p>
            <p>
              <FontAwesomeIcon id="icon" icon={faGraduationCap} />
              Studiespesialisering med bedriftsutvikling og entreprenørskap
            </p>
            <p>
              <FontAwesomeIcon id="icon" icon={faFilePen} />
              Studiespesialisering med fokus på bedriftsutvikling og
        ...
        <h1 className="lang">
          <FontAwesomeIcon icon={faLanguage} /> Språk
        </h1>
