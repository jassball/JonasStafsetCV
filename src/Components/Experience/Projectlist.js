    ...
    const Experiences = [
        {
            ...
            'longDesc': "I gruppeprosjekt fikk vi i case å lage en intuitiv og forenklet variant av Vizrt sine verktøy. Vi designet først siden i Adobe XD, før vi startet kodingen. Vi tok utgangspunkt i Vizrt sine farger for å skape en gjengående inntrykk, men valgte egen logo siden løsningen skulle stå på egne ben. For å skille oss ut, måtte vi engasjere produkteier med en attraktiv UI og funksjoner som de kan utnytte fra deres portefølje.",
            'github': "https://github.com/jassball/Projects/tree/main/StreamDream%20-%20Webdev",
            'image': Streamdream,
        },
        {
            ...
            'longDesc': "Dette klarte vi såpass godt at produkteier selv sa at dette var noe de kunne solgt. For å oppnå dette hadde vi et strekt grunnlag med smidig prosess og godt samarbeid. På dette prosjektet var jeg frontend utvikler.",
        ...
        },
        {
            ...
            'longDesc' : "For å bli bedre kjent med 3D og animasjoner valgte jeg faget Unity utvikling. I dette faget lærte jeg mye om brukeropplevelser og brukergrensesnitt. På gruppeprosjekt eksamen, samlet vi alt vi hadde lært og lagde et spill som nå blir brukt som demo i undervisning.",
