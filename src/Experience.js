                ...
                <div className="exp-desc">
                    ...
                    <div id="row" className="row ">
                        <div id="exp-desc-text" className="col-md-8">
                            ...
                            <p>Link til Github: <a href="https://github.com/jassball/Projects/tree/main/StreamDream%20-%20Webdev" 
                             target="_blank" rel="">Streamingløsning</a></p>
                        </div>


                    <div className="col-md-4">
                        <img alt="streamdream" className="exp-image" src={Streamdream} />
                    </div>
                    ...
                    <div id="next-project" className="col-md-8">
                        <h4>Nettside som lagrer spill og karakterer</h4>
                        ...
                        <p> Link til Github: <a href="https://github.com/jassball/Projects/tree/main/Webdev%20-%20Games">
                            Nettside som lagrer spill og karakterer</a>
                        </p>
                    </div>
                    <div className="col-md-4">
                        <img alt="code-image" className="exp-image" src={CodeImage}/>
                        </div>
                    ...
                    <div className="col-md-4">
                    <img alt="java" className="exp-image" src={JavaImage} />
                    </div>
                    <div id="border-top" className="col-md-12"></div>
                    ...
                    <div className="col-md-4">
                    <img alt="android" className="exp-image" src={Android} />
                    </div>
                    <div id="border-top" className="col-md-12"></div>
                    <div id="last-exp" className="col-md-8">
                    <h4>Unity spill</h4>
                    ...
                    <p>
                        Link til Github: <a href="https://github.com/jassball/Projects/tree/main/MazeEscape%20-%20Unity%20game">Unity spill</a>
                    </p>
                    </div>
                    <div className="col-md-4">
